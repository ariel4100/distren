...
<div class="container">
    <a class="navbar-brand" href="{{ route('home') }}"><img src="{!! isset($data->image_2) ? asset($data->image_2) : null !!}" alt="" class="img-fluid"></a>
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item"><a class="nav-link h5 ml-3 text-uppercase {{ request()->is('productos*') ? 'activo' : '' }}" href="{{ route('categorias') }}">Productos</a></li>
